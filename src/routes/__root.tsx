...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Math Adventure Printables" },
      ...
      { name: "twitter:title", content: "Math Adventure Printables — Learning Through Adventure" },
      { name: "twitter:description", content: "Turn maths practice into an adventure. Premium printable pirate-themed maths activities children aged 5–10 actually love." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/101662c3-3258-4aa3-8bca-e5ee7f71f055" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/101662c3-3258-4aa3-8bca-e5ee7f71f055" },
    ],
    links: [
