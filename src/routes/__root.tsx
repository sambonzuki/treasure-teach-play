...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium pirate-themed printable maths activities children aged 5–10 actually love. Curriculum-aligned, teacher-created, instant download." },
      ...
      { property: "og:description", content: "Turn maths practice into an adventure. Printable, curriculum-aligned resources for parents, teachers, and homeschool families." },
